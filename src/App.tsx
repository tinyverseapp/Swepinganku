...
import { today, getKoasName, saveKoasName, loadPatients, savePatients, saveCurrentTeam, handoverYesterdayPatients, getStorageKey, isRemovedDoctor } from './utils/storage';
...
import { Users, UserPlus, GitPullRequest, CheckCircle2, Stethoscope } from 'lucide-react';
...
export default function App() {
  ...
  return <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col selection:bg-blue-100 selection:text-blue-900">
    ...
    <SettingsModal isOpen={isSettingsModalOpen} onClose={() => setIsSettingsModalOpen(false)} activeTeam={activeTeam} onOpenTeamModal={() => setIsTeamModalOpen(true)} />
  </div>;
}
